...
import flaggedRoutes from "./flagged.routes.js";
import notificationsRoutes from "./notifications.routes.js";
import agentsAdminRoutes from "./agentsAdmin.routes.js";
import managersAdminRoutes from "./managersAdmin.routes.js";
import agentReleasesRoutes from "./agentReleases.routes.js";
import downloadsFolderRoutes from "./downloadsFolder.routes.js";
...
import dnsLogsRoutes from "./dnsLogs.routes.js";
import processDetectionsRoutes from "./processDetections.routes.js";
...
router.use("/flagged", flaggedRoutes);
router.use("/notifications", notificationsRoutes);
router.use("/agents", agentsAdminRoutes);
router.use("/managers", managersAdminRoutes);
router.use("/agent-releases", agentReleasesRoutes);
router.use("/downloads-folder", downloadsFolderRoutes);
router.use("/users", usersRoutes);
router.use("/dns-logs", dnsLogsRoutes);
router.use("/process-detections", processDetectionsRoutes);
