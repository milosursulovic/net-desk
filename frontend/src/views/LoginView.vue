<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-slate-100">
    <div class="bg-white/70 backdrop-blur-md p-8 rounded-2xl shadow-2xl w-full max-w-md">
      ...
      <form @submit.prevent="handleLogin" class="space-y-5">
        <div>
          ...
          <div class="relative">
            <input id="username" v-model.trim="username" type="text" required placeholder="Unesite korisničko ime"
        ...
        <div>
          ...
          <div class="relative">
            <input id="password" v-model="password" type="password" required placeholder="Unesite lozinku"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400 pl-10" />
          </div>
        </div>
